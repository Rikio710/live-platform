...
import { LayoutDashboard, Mic2, Route, Ticket } from 'lucide-react'
    ...
    <div className="flex min-h-[calc(100vh-3.5rem)]">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <nav className="sm:hidden flex border-t border-white/5 bg-[#0d0d14]">
          {NAV.map(n => (
            <Link key={n.href} href={n.href}
              className="flex-1 flex flex-col items-center gap-1 py-3 text-[#8888aa] hover:text-white transition-colors">
              <n.icon size={20} />
